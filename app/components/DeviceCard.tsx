...
export default async function DeviceCard(props: deviceIdProps) {
  ...
  return (
    <Link
      ...
      className={`${props.isEven ? "fadeInLeft" : "fadeInRight"} w-full md:w-5/12 props.img m-3 flex flex-row items-center bg-white border border-gray-200 rounded-lg shadow  md:max-w-xl hover:bg-gray-100 `}
    >

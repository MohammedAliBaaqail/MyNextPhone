...
function Hero() {
    return (react_1["default"].createElement("section", { className: "w-full overflow-hidden h-[90vh] hero_bg  flex justify-start max-md:flex-col max-md:h-[85vh]" },
        react_1["default"].createElement("div", { className: " w-1/2   ml-24   text-8xl max-md:text-6xl  self-center  max-md:mt-auto max-md:w-full max-md:ml-0    " },
            react_1["default"].createElement("h1", { className: " drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] mt-full max-md:ml-auto max-md:text-center " },
                "Discover Your ",

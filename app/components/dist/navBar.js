...
function navBar() {
    return (react_1["default"].createElement("nav", { className: "  nav_bg top-0 px-6   w-full flex flex-col justify-between md:flex-row items-center   py-2 text-neutral-500    lg:py-4" },
